...
| [[!UICONTROL Assign Catalog Product]](./creating-assigning-catalog-products.md) | Välj en befintlig produkt manuellt i [!DNL Commerce] och tilldela den till Amazon. | [[!UICONTROL New Third Party]](./new-third-party-listings.md) |
