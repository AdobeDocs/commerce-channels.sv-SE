...
>
>Om en beställning har fyllts i av Amazon (FBA) men ett objekt finns i `out of stock` status, [!DNL Commerce] kan inte skapa en motsvarande order. Detta är en begränsning av integreringar av inventeringshantering.
